...
const headCells = [
  ...
  { id: 'Goals', numeric: true, disablePadding: false, label: 'Goals' },
  { id: 'Ds', numeric: true, disablePadding: false, label: 'Ds' },
...
/////THe actual file
export default function SortingPlay(props) {
    const {stats} = props
      ...
      <Paper className={classes.paper}>
        <div className={classes.tableWrapper}>
          ...
          >
            ...
            />
            <TableBody>
              {stableSort(stats, getSorting(order, orderBy))
                .map((row, index) => {
